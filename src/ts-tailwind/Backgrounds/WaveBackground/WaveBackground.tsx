...
export default function WaveBackground({
  ...
  return (
    <div className="absolute inset-0 w-full h-full overflow-hidden pointer-events-none bg-gradient-to-br from-white to-[#f8fafc]">
      <canvas ref={canvasRef} id="global-wave-canvas" className="w-full h-full block" />
      <div className="absolute inset-0 pointer-events-none z-10 [background:radial-gradient(circle_at_center,transparent_0%,rgba(255,255,255,0.6)_100%),linear-gradient(to_bottom,transparent_65%,#ffffff_98%)]" />
    </div>
  );
}
